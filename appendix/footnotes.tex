...
\begin{array}{c|c}
	...
	\mathbf{0} & \mathbf{Q}
\end{array}
\right)=\ldots = 1^n\cdot \det Q =\det Q
\end{equation*}
...
\end{gather}
Come ultima conseguenza, se vogliamo studiare il polinomio caratteristico $C_A\left(t\right)$ di una matrice $\mathbf{A}$ a blocchi diagonali $\mathbb{B}$ e $\mathbb{C}$, abbiamo che:
\begin{equation}
