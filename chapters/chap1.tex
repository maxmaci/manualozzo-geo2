...
\end{examples}
\begin{attention}
	Non tutte le topologie sono indotte da una distanza! Definiamo la \textbf{topologia dei complementari finiti} o \textbf{topologia cofinita}\index{topologia!cofinita} sull'insieme $X$ nel modo seguente:
	\begin{gather*}
...
\end{define}
\begin{theorema}[Base della topologia prodotto; Manetti, 3.61.]\label{topprodotto}~{}
\begin{enumerate}
...
\end{enumerate}
\end{demonstration}
\begin{proposition}[Proprietà del prodotto]
