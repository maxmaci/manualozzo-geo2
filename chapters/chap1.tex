...
\end{define}
\begin{define}
	Uno \textbf{spazio metrico}\index{spazio topologico!metrico} $\left(X, d\right)$ è un insieme su cui è definita una distanza.
\end{define}
\begin{define}
...
\end{define}
\begin{define}
Sia $X$ spazio topologico e $A\subseteq X$. A è \textbf{denso}\index{spazio topologico!denso} è denso in $X$ se $\overline{A}=X$ o, in altri termini, tutti i punti di $X$ sono aderenti ad $A$.
\end{define}
\begin{example}
