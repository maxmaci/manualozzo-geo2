...
Uno \textbf{spazio topologico}\index{spazio topologico} $\left(X, \topo\right)$ è un insieme $X$ con una famiglia di sottoinsiemi $\topo\subseteq\setpart{X}$ detta \textbf{topologia}\index{topologia} che soddisfano i seguenti assiomi (detti \textbf{assiomi degli aperti}\index{assiomi!degli aperti}):
	...
	\item \textit{L'unione arbitraria di aperti è un aperto}: dati $\left\{A_i\right\}_{i\in I}$ tali che $A_i\in\topo,\forall i\in I$ ($|I|\leq \infty$), allora $\displaystyle\inter_{i\in I}A_i=A\in\topo$ .
	\item \textit{L'intersezione finita di aperti è aperta}: dati $\left\{A_i\right\}_{i\in I}$ tali che $A_i\in\topo$ $\forall i\in I$ ($|I|< \infty$), allora $\displaystyle\union_{i\in I}A_i=A\in\topo$.
		\end{enumerate}
...
\begin{define} Si può definire equivalentemente su X una topologia $\topo$ usando gli \textbf{assiomi dei chiusi}\index{assiomi!dei chiusi}:
	...
	\item \textit{L'unione finita di chiusi è un chiuso}: dati $\left\{C_i\right\}_{i\in I}$ tale che $C_i\in\topo$ $\forall i\in I$ ($|I|< \infty$), allora $\displaystyle\inter_{i\in I}C_i=C\in\topo$ .
	\item \textit{L'intersezione arbitraria di chiusi è un chiuso}: dati $\left\{C_i\right\}_{i\in I}$ tale che $C_i\in\topo$ $\forall i\in I$ ($|I|\leq \infty$), allora $\displaystyle\union_{i\in I}C_i=C\in\topo$.
		\end{enumerate}
...
%sicuro di voler indicare la topologia euclidea con il pedice?
\begin{equation}
...
\begin{enumerate}[label=\Roman*]
\item 
\item $\impliesdx$ Avendo per ogni coppia di punti distinti due intorni disgiunti, banalmente i due intorni verificano la definizione di \textbf{T1} per intorni.\\
$\impliessx$
