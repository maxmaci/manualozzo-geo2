...
\begin{itemize}
\item \textbf{Norma infinito}: $\displaystyle\mvf{d_\infty}{x}{y}=\max_{i}{\left|x_i-y_i\right|}$
\item \textbf{Norma uno}: $\displaystyle\mvf{d_1}{x}{y}=\sum_{i=1}^{n}\left|x_i-y_i\right|$
\item \textbf{Norma due}: $\displaystyle\mvf{d_2}{x}{y}=\sqrt{\sum_{i=1}^{n}\left|x_i-y_i\right|^2}$
\item \textbf{Norma p}: $\displaystyle\mvf{d_p}{x}{y}=\sqrt[\leftroot{1}\uproot{3}p]{\sum_{i=1}^{n}\left|x_i-y_i\right|^p}$
\end{itemize}
...
\begin{itemize}
	\item \textbf{Norma infinito}: $\displaystyle\mvf{d_\infty}{f}{g}=\max_{x\in[0,\ 1]}{\left|f(\left(x\right)-\left(y\right)\right|}$
...
\begin{define}\textsc{T1.}\label{T1}\\
