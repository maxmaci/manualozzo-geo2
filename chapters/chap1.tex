...
\end{enumerate}
\item Per definizione $\mathcal{P}$ è la meno fine fra tutte le topologie sul prodotto. Per dimostrare B) basta vedere che $p,\ q$ sono continue rispetto alla topologia $\topo_{box}$.\\
