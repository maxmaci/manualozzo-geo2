...
\end{equation*}
	...
	\end{equation*}
			\begin{equation*}
	\widetilde{r}\coloneqq\funztot{ i\circ r}{X}{X}{\underline{x}}{\frac{\underline{x}}{\labs \underline{x}\rabs}}
\end{equation*}
...
\end{equation*}
Infatti $F$ è ben definita, continua e $\mvf{F}{\underline{x}}{0}=\frac{\underline{x}}{\labs \underline{x}\rabs}=\widetilde{r}\left(\overline{x}\right),\ \mvf{F}{x}{1}=\overline{x}=Id_X\left(\overline{x}\right)$.
\end{example}
\begin{corollary}
...
\begin{examples}\textsc{Altri esempi di equivalenze omotopiche.}
	\begin{enumerate}
		...
		\end{equation*}
		Infatti $F$ è banalmente ben definita continua, con $\mvf{F}{\underline{x}}{0}=\left(x,\ y,\ 0\right)=\widetilde{r}\left(\underline{x}\right)$ e $\mvf{F}{\underline{x}}{1}=\left(x,\ y,\ z\right)=Id_{\widetilde{X}}\left(\underline{x}\right)$.\\
