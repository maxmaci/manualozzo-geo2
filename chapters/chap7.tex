...
\begin{demonstration}~{}
	\begin{enumerate}[label=\Roman*]
		...
		\end{cases}
		\end{equation*}
	\item Consideriamo $\funz{f}{\realset^n}{Y=\left\{1\text{ punto}\right\}}$ e $\funztot{g}{Y=\left\{1\text{ punto}\right\}}{\realset^n}{\text{punto}}{g\left(\text{punto}\right)=\underline{0}}$.	$f$ e $g$ sono \textit{continue}, inoltre:
	\begin{gather*}
...
\end{demonstration}
\begin{define}
	Uno spazio topologico è \textbf{contraibile}\index{contraibile} o \textit{contrattile}\seeonlyindex{contrattile}{contraibile} se ha lo stesso tipo di omotopia di un punto.
\end{define}
\begin{examples}~{}
	\begin{enumerate}
...
\end{equation*}
	\begin{equation*}
		\funztot{r}{X}{X}{\underline{x}}{\frac{\underline{x}}{\lvert\lvert \underline{x}\rvert\rvert}}
	\end{equation*}
			\begin{equation*}
	\tilde{r}\coloneqq\funztot{ i\circ r}{X}{X}{\underline{x}}{\frac{\underline{x}}{\lvert\lvert \underline{x}\rvert\rvert}}
\end{equation*}
...
\begin{examples}\textsc{Altri esempi di equivalenze omotopiche.}
	\begin{enumerate}
		...
		\begin{equation*}
			\funztot{r}{X}{A}{\underline{x}}{\frac{\underline{x}}{\lvert\lvert \underline{x}\rvert\rvert}}.\\
		\end{equation*}
		e l'omotopia:
		\begin{equation*}
			\tilde{r}\coloneqq\funztot{ i\circ r}{X}{X}{\underline{x}}{\frac{\underline{x}}{\lvert\lvert \underline{x}\rvert\rvert}}
