...
\begin{lemming} \textsc{del numero di Lebesgue, Kosniowski, teorema 23.4} \label{teo numero lebesgue}\\
...
\subsubsection{Dimostrazione $\pi_1(S^1, 1)\cong\integerset$}
