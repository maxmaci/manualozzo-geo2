...
\begin{observe} \textsc{Proiezione stereografica.} \\
	...
	\end{center}
	 La proiezione stereografica\footnote{Nelle ‘‘Note aggiuntive'', a pag. \pageref{proiezionestereograficanote}, si può trovare la proiezione stereografica per $n=2$.} è in particolare un \textit{omeomorfismo} e, poiché $H\cong\realset^2$ (in quanto iperpiano di $\realset^{n+1}$), si ha $S^n\setminus \{1\text{ punto}\}\cong \realset^n$.
\end{observe}
...
\begin{demonstration}~{}
	...
	\begin{itemize}
		...
		\item $Y$ è chiuso per l'implicazione $1\Rightarrow 3)$ del teorema \ref{quozientehausdorff} (pag. \pageref{quozientehausdorff}), dato che si ha che, prese due mappe continue a valori in uno spazio di \textbf{Hausdorff}, l'insieme su cui coincidono è chiuso.
	\end{itemize}
