...
Osserviamo ora, con un esempio sulla circonferenza, che il corollario \ref{corollario van kampfen} \textit{non} vale se $A$ e $B$ non sono \textit{aperti}.
...
% che corollario \ref{grp fond iniettiva e suriettiva}???
\end{demonstration}
\begin{attention}
