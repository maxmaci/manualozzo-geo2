...
\begin{demonstration}~{}
	\begin{enumerate}[label=\Roman*]
		...
		Poiché $\forall y\in C\ y\in U_i$, si ha che $\displaystyle \union_i U_i\subseteq C$ (dall'inclusione precedente) e  $\union_i U_i\supseteq C$ (perché ogni elemento di $C$ appartiene per ipotesi ad un $U_i$), cioè $C=\union_i U_i$. In particolare, $C$ è unione di aperti e dunque \textit{aperto}.
		\begin{itemize}
