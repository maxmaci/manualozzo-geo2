...
\begin{define}\textsc{Blocco di Jordan.}\\
...
\end{observe}
\begin{define}\textsc{Forma di Jordan.}\\
...
\begin{define}\textsc{Spazio vettoriale invariante.}\\
...
\end{itemize}
\end{observe}
\begin{define}\textsc{Autospazio generalizzato.}\\
...
\begin{define}\textsc{Funzione esponenziale sui numeri complessi.}\\
...
\begin{define}\textsc{Esponenziale di una matrice quadrata complessa.}\\
...
\begin{define}\textsc{Norma infinito di una matrice.}\\
