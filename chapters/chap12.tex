...
\begin{itemize}
	...
	\end{minipage}
	\begin{minipage}[t]{0.13\textwidth}\vspace{-10pt}
		% https://q.uiver.app/?q=WzAsMyxbMSwwLCJcXHBpXnstMX0oVV8wKVxcc3Vic2V0XFxjb21wbGV4c2V0XntuKzF9Il0sWzAsMiwiVV8wIl0sWzIsMiwiXFxjb21wbGV4c2V0Xm4iXSxbMSwyLCJcXG9sZHBoaSIsMl0sWzAsMSwicCIsMl0sWzAsMiwiXFxoYXR7XFxvbGRwaGl9Il0sWzAsMl1d
		\begin{tikzcd}
			& {\pi^{-1}(U_0)\subset\complexset^{n+1}} \\
			\\
			{U_0} && {\complexset^n}
			\arrow["{\oldphi}"', from=3-1, to=3-3]
			\arrow["{p}"', from=1-2, to=3-1]
			\arrow["{\hat{\oldphi}}", from=1-2, to=3-3]
