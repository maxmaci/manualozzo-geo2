...
\end{introduction}
%inserire citazione
\noindent Abbiamo già trattato lo \textit{spazio proiettivo reale} e le sue caratteristiche nel \autoref{chap:azionidigruppo} e \autoref{chap:varietà}. In questo, ci dedicheremo a generalizzare il concetto per un \textit{qualsiasi} spazio vettoriale su campo $\kamp$, utilizzando gli strumenti dell'algebra lineare.\\
...
\end{observe}
\begin{theorema} \label{puntiposizionegeneraleesistenzabase}
...
\begin{demonstration}~{}
	...
	Consideriamo ora $\funz{\pi_0=\pi_{\mid S^{2n+1}}}{S^{2n+1}}{\proj[n]{\complexset}}$. Per dimostrare che $\proj[n]{\complexset}$ è di Hausdorff, è sufficiente dimostrare che $\pi_0$ sia una identificazione chiusa: in questo modo, per il teorema \ref{quozientehausdorff} (pag. \pageref{quozientehausdorff}) basta dimostrare che $\pi_0$ è un'identificazione \textit{chiusa}.\\
