...
\vspace{-3mm}
\end{examples}
\begin{lemming}[Connesso è disgiunto o sottoinsieme di un aperto/chiuso; Manetti, 4.4.]~{}\\
...
\end{theorema}
\begin{demonstration}
Supponiamo $X=\left[0,\ 1\right]=C\cup D$ con $C,\ D$ entrambi chiusi \textit{oppure} $C,\ D$ entrambi aperti.\\
