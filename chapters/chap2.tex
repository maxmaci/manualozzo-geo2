...
\begin{theorema}\textbf{Compatto in un Hausdorff è chiuso; Manetti, 4.48}\\\label{compatto in hausdorff chiuso}
...
\end{digression}
\begin{theorema}\textsc{Funzione continua da compatto ad Hausdorff è chiusa (Manetti 4. 52)}\\ \label{da compatto in T_2 è chiuso}
