...
\begin{theorema}\textsc{Manetti, 4.48}\\
...
\begin{theorema}\textsc{Manetti, 4.42}\\
...
\begin{demonstration}
	...
	Per vedere che è limitato consideriamo un ricoprimento aperto $\mathcla{A}=\left\{ (-n,\ n)\cap K\right\}_{n\in\naturalset}$ di $K$. Siccome è compatto allora esiste un sottoricoprimento finito, ovvero:
	\begin{gather*}
